export const en = {
  ...
  'sync.disconnected': 'Sync session expired. This can happen when signing in on another device.',
...
export const fr = {
  ...
  'sync.disconnected': 'Session de synchronisation expirée. Cela peut arriver lors d\u2019une connexion sur un autre appareil.',
